...
(function ($) {
    ...
    if (firstslider.length) {
        $("#first-slider").owlCarousel({items: 1, loop: true})
    }
    ...
    function setAnimation(_elem, _InOut) {
        // Store all animationend event name in a string. cf animate.css documentation
    ...
    if (rscounter.length) {
        $('.rs-counter').counterUp({delay: 20, time: 1500});
    }
    /*-------------------------------------
  	Preloder Js here
  	---------------------------------------*/
    ...
    if (singleproductimage.length) {
        $('.single-product-image').slick({slidesToShow: 1, slidesToScroll: 1, arrows: false, fade: true, asNavFor: '.single-product-nav'});
    }
    ...
    if ($('#googleMap').length) {
        var initialize = function () {
            ...
            var map = new google
                .maps
                .Map(document.getElementById("googleMap"), mapOptions);
